...
$(function() {
  ...
  async function main() {  
    ...
    //ABIs
  	...
  	//contracts
    const SNOWGLOBE_ADDR = "0x751089F1bf31B13Fa0F0537ae78108088a2253BF";
    ...
    //tokens
    const SPGL_ADDRESS = "0x751089f1bf31b13fa0f0537ae78108088a2253bf";
	...
	const approveSUSHI = async function() {
		return snowglobeContract_approve(SUSHIAVAX_ABI, SNOWGLOBE_ADDR, SUSHI_AVAX_ADDR, App)
	}
	const stakeSUSHI = async function() {
		return snowglobeContract_stake(SNOWGLOBE_ABI, SNOWGLOBE_ADDR, 1, SUSHI_AVAX_ADDR, App)
	}
	const approveSPGL = async function() {
		return icequeenContract_approve(SNOWGLOBE_ABI, ICEQUEEN_ADDR, SPGL_ADDRESS, App)
	}
	const stakeSPGL = async function() {
		return icequeenContract_stake(ICEQUEEN_ABI, ICEQUEEN_ADDR, 1, SPGL_ADDRESS, App)
	}
